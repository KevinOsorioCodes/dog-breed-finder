...
describe('BreedImageStorage', () => {
  ...
  // Tests that getByBreed method returns the correct breed and images
  ...
  // Tests that getBySubBreed method returns the correct breed, subBreed and images
  ...
  // Tests that getAll method returns the correct random breed and images
